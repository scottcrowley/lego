...
<div class="w-full px-3 sm:px-0">
    <div class="rounded shadow">
        ...
        <div class="bg-white p-4 py-6 rounded-b">
            <data-grid 
                label="Parts" 
                image_base_url="https://cdn.rebrickable.com/media/thumbs/parts/ldraw/15/{part_num}.png/100x100p.png"
                image_field="part_num" 
                ...
                :valnames="[
                    ...
                    {label: 'Category', field: 'category_label', title: false, sortable: false, sorted: false, sortdesc: false, boolean: false},
                    ]"
